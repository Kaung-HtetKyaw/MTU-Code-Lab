  ...
  <div class="bg-white">
    <div class="container">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-16">
        ...
        >
          <div
            class="text-sm uppercase tracking-wider font-semibold opacity-75"
            v-text="tag.pages.length"
          ></div>
...
export default {
  ...
  methods: {
    classesFor(tag) {
      ...
      if (tag.name === "PHP") return "bg-purple text-white";
      if (tag.name === "Vue" || tag.name === "Vuepress")
